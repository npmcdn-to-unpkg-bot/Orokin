                ...
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        <div class="thumbnail no-margin-bottom">
                            <?= $this->Html->image('/assets_admin/img/thumbnails/picjumbo.com_IMG_4566.jpg', ['alt' => '', 'class' => 'img-responsive']); ?>
                            <div class="caption">
                ...
                <div class="card card-success">
                    ...
                    <div class="card-body no-padding">
                        <ul class="message-list">
                            <a href="#">
                                <li>
                                    <?= $this->Html->image('/assets_admin/img/profile/profile-1.jpg', ['alt' => '', 'class' => 'profile-img pull-left']); ?>
