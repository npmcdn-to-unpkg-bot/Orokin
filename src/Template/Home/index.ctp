...
<div class="tp-banner-container rs-youplay rs-fullscreen">
    <div class="tp-banner">
        <ul>
            <!-- SLIDE NR. 1  -->
            <li data-thumb="http://i.imgur.com/wQzVkEt.jpg" data-saveperformance="on" data-transition="random-static" data-slotamount="7" data-masterspeed="700">
                <!-- MAIN IMAGE -->
                <img src="assets/images/dummy.png" alt="" data-lazyload="http://i.imgur.com/wQzVkEt.jpg" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                <!-- LAYERS -->
            ...
            <!-- SLIDE NR. 2  -->
            <li data-thumb="http://i.imgur.com/8BLC0R9.jpg" data-saveperformance="on" data-transition="random-static" data-slotamount="7" data-masterspeed="700">
                <!-- MAIN IMAGE -->
                <img src="assets/images/dummy.png" alt="" data-lazyload="http://i.imgur.com/8BLC0R9.jpg" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                <!-- LAYERS -->
            ...
            <!-- SLIDE NR. 3  -->
            <li data-thumb="http://i.imgur.com/wZdfpkk.jpg" data-saveperformance="on" data-transition="random-static" data-slotamount="7" data-masterspeed="700">
                <!-- MAIN IMAGE -->
                <img src="assets/images/dummy.png" alt="" data-lazyload="http://i.imgur.com/wZdfpkk.jpg" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                <!-- LAYERS -->
